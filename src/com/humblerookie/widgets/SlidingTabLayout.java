package com.humblerookie.widgets;

/**
 * Created by root on 13-01-2015.
 */
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            defTextColor = ta.getColor(R.styleable.SlidingTabLayout_defaultTextColor, Color.GRAY);
            selTextColor = ta.getColor(R.styleable.SlidingTabLayout_selTextColor, Color.WHITE);
    ...
    protected TextView createDefaultTabView(Context context) {
        TextView textView = new TextViewLight(context);
